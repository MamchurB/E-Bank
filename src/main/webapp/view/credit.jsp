        ...
        <div class="data">
            ...
            <div class="data__form">
                <div class="data__bank-account">
                    ...
                    <select>
                        <option value="56785678567856785678567867">Account 1</option>
                        <option value="56785678567856785678567867">Account 2</option>
                        <option value="56785678567856785678567867">Account 3</option>
                    </select>
                </div>
